          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="../assets/img/menu/snunomono.png" class="glightbox"><img src="../assets/img/menu/snunomono.png" class="menu-img img-fluid" alt=""></a>
                <h4>Sunomono</h4>
                <p class="ingredients">
                  Pepino fatiado com sabor adocicado
                </p>
                <p class="price">
                  R$7,99
                </p>
